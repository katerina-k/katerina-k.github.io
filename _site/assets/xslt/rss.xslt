...
<xsl:template match="/rss">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="" class="icon-tree"> PCHES</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="/" title="PCHES – Program on Coupled Human Earth Systems">
				<img src="/assets/img/logo.png" alt="PCHES – Program on Coupled Human Earth Systems">
			</a>
